...
userName ? (greeting.innerText=`Hello, ${userName}`) : (greeting.innerText='Why did you not tell me your name.')


function shakeMagic8Ball(){

//Get user question
let userQuestion = prompt('What question to want to ask to the most amazing, glorious, respectable, smart, bright, and handsome 8 ball?')
